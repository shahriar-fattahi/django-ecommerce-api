...
urlpatterns = [
    ...
    path("change-info/", apis.ChangeUserDetasilsApiView.as_view(), name="change-user-information"),
    path("delete-account/", apis.DeleteUserApiView.as_view(), name="delete-user")
